    ...
    <>
        ...
        <main className="flex-1 p-4 md:p-8">
            <div className="ios-glass-final rounded-3xl p-6 w-full max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 mb-4 border-b border-slate-200 dark:border-white/10 pb-4">
                    ...
                    {notificationsData[activeTab].list.length > 0 && (
                        <button onClick={handleDeleteAll} className="flex-shrink-0 flex items-center text-sm text-red-500 hover:text-red-700 dark:hover:text-red-300 transition-colors p-2 rounded-lg hover:bg-red-500/10">
                            <Trash2 size={16} />
                            <span className="hidden sm:inline sm:ml-2 whitespace-nowrap">Очистить все</span>
                        </button>
                    )}
                </div>
