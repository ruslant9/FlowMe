...
const availableInterests = [
    "Дизайн", "Музыка", "Кино", "Фотография", "Искусство", "Литература", "Архитектура", "Театр", "Поэзия", "Танцы", "Вокал",
    "Программирование", "Наука", "Технологии", "Космос", "Робототехника", "AI & ML", "Гаджеты", "Стартапы", "Биотехнологии",
    "Видеоигры", "Чтение", "Настольные игры", "Комиксы", "Аниме и Манга", "Сериалы", "Подкасты", "Коллекционирование",
                ...
                >
                    <div className="pt-4 space-y-4 border-t border-slate-200 dark:border-white/10">
                        <div className="flex justify-between items-center">
                            ...
                            <button onClick={resetFilters} className="px-3 py-1 text-sm font-semibold text-slate-600 dark:text-white/70 hover:bg-slate-200 dark:hover:bg-white/10 rounded-lg md:hidden">
                                Сбросить
                            </button>
                        </div>
