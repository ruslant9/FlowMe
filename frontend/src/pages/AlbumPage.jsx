...
const AlbumPage = () => {
    ...
    return (
        <main className="flex-1 overflow-y-auto">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-center space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="flex items-center space-x-2 mt-4 text-sm flex-wrap justify-center md:justify-start" style={{ color: textColor }}>
            ...
            <div className="p-6 md:p-8 relative z-10 bg-slate-100 dark:bg-slate-900">
