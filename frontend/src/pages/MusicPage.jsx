...
<button
onClick={onClick}
className={flex-shrink-0 flex items-center space-x-2 px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${ active ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-500 hover:text-slate-800 dark:hover:text-white' }}
>
{children}
</button>
);
    ...
    <main className="flex-1 overflow-y-auto bg-slate-100 dark:bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="px-6 md:px-8 border-b border-slate-300 dark:border-slate-700">
                <div className="flex items-center gap-x-2 -mb-px overflow-x-auto no-scrollbar">
            {/* --- КОНЕЦ ИЗМЕНЕНИЯ --- */}
