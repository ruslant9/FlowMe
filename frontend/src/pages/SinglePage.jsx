    ...
    return (
        <main className="flex-1 overflow-y-auto">
            <div className="relative">
                ...
                >
                    <button onClick={() => navigate(-1)} className="absolute top-10 left-6 flex items-center space-x-2 text-sm z-10 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-lg hover:scale-105 hover:bg-white transition-all font-semibold"
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-center space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            <span className="text-sm font-bold" style={{ color: textColor, opacity: 0.8 }}>Сольный трек (сингл)</span>
                            ...
                            <div className="flex items-center space-x-2 mt-4 text-sm" style={{ color: textColor }}>
                                ...
                                <span className="opacity-70">• {track.releaseDate ? format(new Date(track.releaseDate), 'MMMM yyyy', { locale: ru }) : ''} • 1 трек, {totalMinutes} мин.</span>
                            </div>
                        </div>
                    </div>
                </div>
