...
return (
// --- НАЧАЛО ИЗМЕНЕНИЯ ---
<div style={{ height: 'calc(var(--vh, 1vh) * 100)' }} className={w-full font-sans transition-colors duration-300 relative ${ theme === 'dark' ? 'bg-liquid-background text-white' : 'bg-slate-100 text-slate-900' } ${currentTrack ? 'pb-[100px]' : ''}}>
{/* --- КОНЕЦ ИЗМЕНЕНИЯ --- */}
{theme === 'dark' && (
