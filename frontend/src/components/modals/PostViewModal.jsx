...
import { X, Heart, MessageCircle, ChevronLeft, ChevronRight, MoreHorizontal, Check, ChevronDown, Users, Loader2, Send, Smile, Trash2, Pin, MessageSquareOff, Edit, XCircle as CancelVoteIcon, Clock, PlusCircle } from 'lucide-react';
                                            ...
                                            {sortedComments.length > 0 ? sortedComments.map(comment => (
                                                <Comment 
                                                    ...
                                                    onReply={(c) => {
                                                        ...
                                                        setReplyingTo({ ...c, username: authorName }); 
                                          ...
                                          <form onSubmit={handleCommentSubmit} className="flex items-start space-x-3">
                                              ...
                                              <div className="relative flex-1">
                                                  <input 
                                                      ...
                                                      className="w-full bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-2 pr-10 md:pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed"/>
